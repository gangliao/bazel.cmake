...
**bazel.cmake** is a seamless submodule which aims to mimic the behavior of bazel to simplify the usability of CMake in **any mainstream operating systems** (Linux, Mac OS, Windows, Android, IOS). 
